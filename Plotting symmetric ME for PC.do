********************************************************************************
***PLOTTING INTERACTIONS BETWEEN MEAN INCOME GROWTH AND Private Credit*************
**********Here we plot marginal effect for Z (PC)**********************
version 14.2
...
*margins, dydx(lnPC) at((min) dlnMI) at((p25) dlnMI) at((p50) dlnMI) at((p75) dlnMI) at((max) dlnMI)
...
graph twoway hist dlnMI, width(0.05) percent color(gs14) yaxis(2) 						///
	    ...
	    ||   ,																			///
			 ...
			 ytitle("Marginal Effect of Private-sector credit to GDP", axis(1) size(2.5))    ///
             xsca(titlegap(2))															///
             ysca(titlegap(2))															///
